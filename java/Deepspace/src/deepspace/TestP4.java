...
public class TestP4 {
    public static void main(String[] args) {
        ...
        Loot loot3 = new Loot(1,1,1,1,1, true, false);
        Loot loot4 = new Loot(1,1,1,1,1, false, true);
        ...
        NumericDamage damage1 = new NumericDamage(3,5);
        NumericDamage damage2 = new NumericDamage(damage1);
        SpecificDamage damage3 = new SpecificDamage(arraywt2,10);
        SpecificDamage damage4 = new SpecificDamage(damage3);
        NumericDamage damage5 = new NumericDamage(0,0);
        NumericDamage damage6 = new NumericDamage(1,0);
        ...
        Damage dam1 = new NumericDamage(3,5);
        Damage dam2 = new SpecificDamage(arraywt2, 10);
        Damage dam3 = new NumericDamage(0,0);
        Damage dam4 = new NumericDamage(1,0);
        Damage dam5 = new SpecificDamage(arraywt,5);
        Damage dam6 = new SpecificDamage(arraywt2,0);
        Damage dam7 = new NumericDamage(7,0);
        Damage dam8 = new NumericDamage(0,7);
        Damage dam9 = new SpecificDamage(arraywt3,5);
        Damage dam10 = new NumericDamage(7,1);
        Damage dam11 = new SpecificDamage(arraywt2,1);
        Damage dam12 = new NumericDamage(3,7);
        Damage dam13 = new SpecificDamage(arraywt,5);
        Damage dam14 = new SpecificDamage(arraywt3,0);
        Damage dam15 = new NumericDamage(1,1);
        Damage dam16 = new SpecificDamage(arraywt4,1);
        Damage dam17 = new NumericDamage(3,3);
        Damage dam18 = new SpecificDamage(arraywt,3);
        ...
        System.out.println("\n\n################# POWER EFFICIENT SPACESTATION ################");
        SpaceStation ss2 = new PowerEfficientSpaceStation(ss1);
        System.out.println(ss2.toString());
        fire = ss1.fire();
        System.out.println("fire SpaceStation: " + fire);
        fire = ss2.fire();
        System.out.println("fire PowerEfficientSpaceStation: " + fire);
        Transformation t = ss2.setLoot(loot3);
        System.out.println(t);
        t = ss2.setLoot(loot4);
        System.out.println(t);
        
        //BETAPOWEREFFICIENTSPACESTATION
        System.out.println("\n\n################# BETA POWER EFFICIENT SPACESTATION ################");
        SpaceStation ss3 = new BetaPowerEfficientSpaceStation(ss1);
        ...
        System.out.println("fire PowerEfficientSpaceStation: " + fire);
        fire = ss3.fire();
        System.out.println("fire BetaPowerEfficientSpaceStation: " + fire);
        fire = ss3.fire();
        System.out.println("fire BetaPowerEfficientSpaceStation: " + fire);
        fire = ss3.fire();
        System.out.println("fire BetaPowerEfficientSpaceStation: " + fire);
        ...
        //faltaria la spacecity, me da pereza
    }
}
